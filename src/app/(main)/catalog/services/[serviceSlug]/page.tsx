...
export default async function ServicePage({
  ...
  return (
    <div className="mx-auto flex flex-col gap-10 bg-[#FBFBFB] px-[120px] pb-[200px] pt-10 max-lg:px-[27px] max-lg:pt-[64px]">
      <Breadcrumb
        linksList={[
          { href: '/', name: 'Главная' },
      ...
      <div className="flex flex-col gap-10">
        <h1 className="text-5xl font-semibold text-blue-3 max-lg:text-4xl">
          {service.Title}
        </h1>
        <div className="flex max-w-full gap-10 max-[2000px]:max-w-[1390px] max-lg:flex-col">
          <ServicesCarousel
            imagesStrings={[
              service.Image1,
              service.Image2,
          ...
          <div className="flex flex-col justify-between gap-4">
            <div className="flex w-[675px] flex-col gap-4 max-lg:mb-[65px] max-lg:w-auto">
              <h2 className=" text-3xl font-bold uppercase max-[2000px]:text-2xl">
                Что это такое?
              </h2>
              <div className="flex flex-col gap-3">
                {service.Description.map((description) => (
                  <p
                    className=" text-xl font-medium opacity-80 max-[2000px]:text-lg max-lg:text-base "
                    key={description}
                  >
                    {description}
                  </p>
